...
import 'package:create_sticker/features/sticker/presentation/pages/sticker_pack_detail_page.dart';
  ...
  routes: [
    ...
    GoRoute(
      ...
      builder: (context, state) {
        ...
        final pack = state.extra as StickerPack;

        return StickerPackDetailsPage(pack: pack);
      },
    ),
  ],
